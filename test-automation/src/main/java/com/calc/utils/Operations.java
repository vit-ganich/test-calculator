...
import static com.calc.utils.OperationsEnum.*;
import static java.util.concurrent.ThreadLocalRandom.current;

/**
 * Class with static auxiliary methods for operations.
...
public class Operations {
     ...
     */
    public static int performOperation(OperationsEnum operation, int value1, int value2) throws InvalidArgumentException {
        switch (operation) {
            case ADDITION:
     ...
     */
    public static String chooseRequestOperand(OperationsEnum operation, Boolean isGet) throws InvalidArgumentException {
        switch (operation) {
            case ADDITION:
                return "add";
            case DIVISION:
    ...
    /**
     * Max and min values are divided to 2 to avoid the Integer Overflow in case of multiplication
     *
